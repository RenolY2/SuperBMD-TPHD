...
namespace SuperBMDLib.BMD
{
    public class MAT3
    {
        ...
        public MAT3(EndianBinaryReader reader, int offset)
        {
            ...
            {
                LoadInitData(reader, m_RemapIndices[i], mat4);
            }
        ...
        private void LoadInitData(EndianBinaryReader reader, int matindex, bool mat4=false)
        {
            ...
            if (mat4)
            {
                reader.ReadInt16(); // Mat4 has 2 extra bytes at the end of the init data
            }
            //mat.Debug_Print();
            m_Materials.Add(mat);
        }
